...
{   
    ...
    /* 配置重映射 */
    GPIO_PinRemapConfig(GPIO_PartialRemap1_TIM2, ENABLE);       //开启TIM2的部分重映射模式1，将TIM2_CH1_ETR映射到PA15(详见手册)
    GPIO_PinRemapConfig(GPIO_Remap_SWJ_JTAGDisable, ENABLE);    //关闭PA15的JTDI功能(详见手册)
